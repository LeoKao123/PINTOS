...
struct switch_threads_frame {
  ...
  char fpu_reg[108];   /* Saved FPU register. */
...
/* Offsets used by switch.S. Previously defined as  
   #define SWITCH_CUR 20
   #define SWITCH_NEXT 24 
   But since adding fpu, we will add 108 bytes to 
   both SWITCH_CUR and SWITCH_NEXT
*/
